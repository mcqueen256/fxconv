...
impl DataSet {
    ...
    fn add(datetime: DateTime<FixedOffset>, data: Vec<f32>) {
...
impl Converter {
    ...
    fn consume_line(&self, line: String) {
...
/// Pack the input string/line data into rows and columns
struct Packer {
